...
public class BuildingInstance implements Serializable {
	...
	public static void loadExtent(Path file) {
		List<BuildingInstance> loaded = ExtentPersistence.loadExtent(file);
		EXTENT.clear();
	...
	public LocalDateTime getTimeTillConstruction() {
		return timeTillConstruction;
	}

	public void setTimeTillConstruction(LocalDateTime timeTillConstruction) {
		this.timeTillConstruction = timeTillConstruction;
	}
